...
// Obtener los datos de la tabla tbl_series
$sentencia = $conexion->prepare("SELECT * FROM `tbl_series`");
$sentencia->execute();
$lista_tbl_series = $sentencia->fetchAll(PDO::FETCH_ASSOC);

if (isset($_GET["txtID"])) { // lógica para eliminar una serie
    ...
    $sentencia = $conexion->prepare("DELETE FROM `tbl_series` WHERE `id`=:id");
    // Asignamos los valores que vienen del metodo GET a la consulta
    $sentencia->bindValue(":id", $txtID);
    $sentencia->execute();
    $sentencia->execute();
    header("Location:index.php?mensaje=serie eliminada");
}
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table" id="tabla_id">
                ...
                <tbody>
                    <?php foreach ($lista_tbl_series as $registro) { ?>
                        <tr class="">
                            <td scope="row">
